...
<html lang="en">
<head>
<title>Titan Fitness Admin</title>
<meta charset="UTF-8" />
...
<div id="content">
  <div id="content-header">
    ...
    <h1 class="text-center">Manage Customer Progress <i class="fas fa-signal"></i></h1>
  </div>
        ...
        $result=mysqli_query($conn,$qry);
          ...
          echo"<table class='table table-bordered table-hover'>
            ...
            echo"<tbody> 
                ...
                <td><div class='text-center'><a href='view-progress-report.php?id=".$row['user_id']."'><i class='fas fa-file'></i> View Progress Report</a></div></td>
