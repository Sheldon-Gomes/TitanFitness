...
<form role="form" action="index.php" method="POST">
    <?php 
            ...
            //update query
            $qry = "UPDATE members SET amount='$amountpayable', expiry_date='$plan_expiry', plan='$plan', status='$status', paid_date='$curr_date',services='$abc', reminder='0' WHERE user_id='$id'";
                                            ...
                                            <tr>
                                                <td class="content-block">
                                                    <table class="invoice">
                                                        <tbody>
                                                        <tr>
                                                            <td><div style="float:left">Invoice #TitanFitness_<?php echo(rand(100000,10000000));?> <br> Mumbai, <br>India </div><div style="float:right"> Last Payment: <?php echo $paid_date?></div></td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <table class="invoice-items" cellpadding="0" cellspacing="0">
                                                                    ...
                                                                    <tr>
                                                                        <td><?php foreach ($services as $value) {    echo $value, " ";}?>
                                                                    </td>
