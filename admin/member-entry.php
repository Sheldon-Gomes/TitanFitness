      ...
      <div class="widget-box">
        ...
        <div class="widget-content nopadding">
          <div class="form-horizontal">
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" id="mask-phone" name="contact" placeholder="9876543210" class="span8 mask text" maxlength="10"  pattern="[0-9]{10}"  title="Please enter a valid mobile number" required>
        ...
        <div class="widget-content nopadding">
          <div class="form-horizontal">
            ...
            <div class="control-group">
              <label class="control-label">Total Amount Per Month</label>
              <div class="controls">
                <div class="input-append">
                  <span class="add-on">₹</span> 
                  <input type="number" placeholder="50" name="amount" class="span11" onclick="reslt()" readonly required>
                  </div>
              </div>
            </div>
            
           <!-- $services=array('Fitness', 'Cardio');
                $servicecharge=array('Fitness' => 5000,
                                      'Sauna' => 4000,
                                      'Cardio' => 3000); !-->
