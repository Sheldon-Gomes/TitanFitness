...
<div id="content">
  <div id="content-header">
    ...
    <h1 class="text-center">Membership Renewal <i class="fas fa-group"></i></h1>
  </div>
        ...
        $result=mysqli_query($conn,$qry);
          ...
          echo"<table class='table table-bordered data-table table-hover'>
            ...
            <tbody> 
                ...
                <td><div class='text-center'><a href='user-payment.php?id=<?php echo $row['user_id']?>'><button class='btn btn-success btn'><i class=''></i> Renew Membership</button></a></div></td>
