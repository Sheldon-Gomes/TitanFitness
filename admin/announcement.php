...
<div id="content-header">
  <div id="breadcrumb"> <a href="index.php" title="Go to Home" class="tip-bottom"><i class="fas fa-home"></i> Home</a><a href="announcement.php" class="current">Add Announcements</a> </div>
      ...
      <div class="widget-content">
        <div class="control-group">
          <form action="post-announcement.php" method="POST">
            <div class="controls">
              <textarea class="span12" name="message" rows="6" placeholder="Enter text ..." required autofocus></textarea>
            </div>
            <div class="controls">
