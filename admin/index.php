...
<!--Action boxes-->
  <div class="container-fluid">
    <div class="quick-actions_homepage"style="margin:auto;">
    ...
    <div class="row-fluid">
      <div class="widget-box">
        <div class="widget-title bg_lg"><span class="icon"><i class="fas fa-file"></i></span>
          <h5>Earnings and Expenses Report</h5>
        </div>
        <div class="widget-content" >
          <div class="row-fluid">
            <div class="span8">
              <!-- <div id="piechart"></div>   -->
              <div id="top_y_div" style="width: 700px; height: 290px;"></div>
            </div>
            <div class="span4">
              <ul class="site-stats">
                ...
                <li class="bg_ly"><i class="fas fa-money-bill"></i> <strong>₹ <?php include 'actions/total-exp.php';?></strong> <small>Total Expenses</small></li>
        ...
        <div class="widget-box">
          ...
          <div class="widget-content nopadding collapse in" id="collapseG2">
            <ul class="recent-posts">
              ...
              <div id="donutchart" style="margin:auto; width: 600px; height: 300px;"></div>
      ...
      <div class="span6">
        <div class="widget-box">
          ...
          <div class="widget-content nopadding collapse in" id="collapseG2">
            ...
            <div id="donutchart2022" style="margin:auto;width: 600px; height: 300px;"></div>
            </ul>
          </div>
        </div>   
      </div>
            ...
            <ul class="recent-posts">
              ...
              <?php
                ...
                while($row=mysqli_fetch_array($result)){
                  ...
                  echo"<span class='user-info'> Date: ".$row['date']." </span>";
