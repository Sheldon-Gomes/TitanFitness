  ...
  <ul>
    ...
    <li class="submenu"> <a href="#"><i class="fas fa-users"></i> <span>Manage Members</span> <span class="label label-important"><?php include 'dashboard-usercount.php';?> </span></a>
      <ul>
        ...
        <li class="<?php if($page=='payment'){ echo 'active'; }?>"><a href="payment.php"><i class="fas fa-arrow-right"></i> <span>Membership Renewal</span></a></li>
    ...
    <!--
      <li class="submenu"> <a href="#"><i class="fas fa-tasks"></i> <span>Manage Customer Progress</span></a>
    <ul>
        <li class="<?php if($page=='manage-customer-progress'){ echo 'active'; }?>"><a href="customer-progress.php"><i class="fas fa-arrow-right"></i>Manage Customer Progress</a></li>
    ...
    <li class="submenu"> <a href="#"><i class="fas fa-bullhorn"></i> <span>Announcements</span></a>
    <ul>
        <li class="<?php if($page=='manage-announcement'){ echo 'active'; }?>"><a href="manage-announcement.php"><i class="fas fa-arrow-right"></i> Announcements</a></li>
        <li class="<?php if($page=='announcement'){ echo 'active'; }?>"><a href="announcement.php"><i class="fas fa-arrow-right"></i> Add Announcement</a></li>
