...
<head>
    ...
    <body style="background:url(bg.jpg);background-repeat:no-repeat;background-size:100%">
        <div id="loginbox">            
            ...
            <div class="control-group normal_text"> <h3><img src="img/icontest4.png" alt="Logo" /> Admin Login</h3></div>
                <div class="control-group">
                    <div class="controls">
                        <div class="main_input_box">
                            <span class="add-on bg_lg"><i class="fas fa-user-circle"></i></span><input type="text" name="user" placeholder="Username" autofocus required/>
                        </div>
                    </div>
                </div>
                <div class="control-group">
            ...
            <a href="customer/index.php"><h5 >Customer Login</h5></a>
            </div>
