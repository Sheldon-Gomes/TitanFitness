...
<!--Header-part-->
<div id="header">
  <h1><a href="index.php"> Titan Fitness System</a></h1>
</div>
<!--close-Header-part--> 
      ...
      <div class="span12">
        <div class="widget-box">
          ...
          <div class="widget-content">
            <div class="row-fluid">
              <div class="span4">
                <table class="">
                  <tbody>
                    <tr>
                      <td><h4> Titan Fitness Club</h4></td>
                    </tr>
                    <tr>
                      <td>Mumbai, India</td>
                    </tr>
                    ...
                    <tr>
                      <td>Tel: 98198-95046</td>
                    </tr>
                    <tr>
                      <td >Email: support@titanfitness.com</td>
                    </tr>
                  </tbody>
                </table>
              </div>
              ...
              <div class="span8">
                ...
                <table class="table table-bordered table-invoice-full">
                  <tbody>
                    <tr>
                      <td class="msg-invoice" width="55%"> <div class="text-center"><h5><?php echo $row['fullname']; ?>'s Body Structure stated as from <?php echo $row['ini_bodytype']; ?> to <?php echo $row['curr_bodytype']; ?>. <br /> With Total Weight Differences of <?php include '../pages/actions/weight-diff.php';?> KG <br /> As per records of <?php echo $row['progress_date']; ?></h5>
                        <div class="text-center"><h5>Last Payment Done: ₹<?php echo $row['amount']; ?>/-</h5>
            ...
            <div class="row-fluid">
                <div class="pull-left">
                <h4>Dear <?php echo $row['fullname']; ?>,<br/> <br/>Your Membership is currently <?php echo $row['status']; ?>! <br/></h4><p>Thank you for choosing our services.<br/>- on the behalf of whole team</p>
                </div>
