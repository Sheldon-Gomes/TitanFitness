        ...
        <div class="widget-content nopadding">
          <form action="add-member-req.php" method="POST" class="form-horizontal">
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" class="span11" name="fullname" placeholder="Fullname" autofocus required/>
              </div>
            </div>
            <div class="control-group">
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="password"  class="span11" name="password" placeholder="**********"  autocomplete="off" required/>
        ...
        <div class="widget-content nopadding">
          <div class="form-horizontal">
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" id="mask-phone" name="contact" placeholder="9876543210" class="span8 mask text" maxlength="10"  pattern="[0-9]{12}"  title="Please enter a valid mobile number" required>
        ...
        <div class="widget-content nopadding">
          <div class="form-horizontal">
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <label>
                  <input type="checkbox" value="Fitness" name="services[]" />
                  Fitness <small>- $55 per month</small></label>
                <label>
                  <input type="checkbox" value="Sauna" name="services[]" />
                  Sauna <small>- $35 per month</small></label>
                <label>
                  <input type="checkbox" value="Cardio" name="services[]" />
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <div class="input-append">
                  ...
                  <input type="number" placeholder="50" name="amount" class="span11" readonly required>
                  </div>
              </div>
            </div>
