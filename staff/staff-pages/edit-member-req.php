...
<form role="form" action="index.php" method="POST">
    <?php 
            ...
            //update query
            $qry = "update members set fullname='$fullname', username='$username',dor='$dor', gender='$gender', services='$abc', amount='$totalamount', plan='$plan', address='$address', contact='$contact' where user_id='$id'";
