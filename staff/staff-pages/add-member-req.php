...
$password = md5($password);
  ...
  $dt = strtotime($curr_date);
  $plan_expiry = date("Y-m-d", strtotime("+$plan month", $dt));

include 'dbcon.php';
//code after connection is successfull
$qry = "INSERT INTO members(fullname,username,password,dor,gender,services,amount,p_year,paid_date,plan,address,contact,expiry_date) values ('$fullname','$username','$password','$dor','$gender','$abc','$totalamount','$p_year','$paid_date','$plan','$address','$contact','$plan_expiry')";
$result = mysqli_query($conn,$qry); //query executes

$query1="select * from members where plan='$plan'";
      ...
      $query2= "insert into members(expire) value ('$expiredate')";
