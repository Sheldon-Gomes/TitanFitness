...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="index.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a><a href="announcement.php">Announcements</a> <a href="#" class="current">Announcements</a> </div>
    <h1 class="text-center">Announcements <i class="icon icon-group"></i></h1>
  </div>
  <div class="container-fluid">
    <hr>
    <!--<a href="announcement.php"><button class="btn btn-danger" type="button">Make Announcements</button></a>!-->
    <div class="row-fluid">
      <div class="span12">
      ...
      $cnt = 1;
        ...
        <div class="text-right" class="span6">
        <a href="announcement.php"><button class="btn btn-danger" type="button">Make Announcements</button></a>
            </div>
      </div>
    </div>
