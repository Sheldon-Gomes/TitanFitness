...
<div id="content">
  <div id="content-header">
    ...
    <h1 class="text-center">Registered Member's Membership Details <i class="icon icon-group"></i></h1>
  </div>
    ...
    <div class="row-fluid">
      ...
      <div class='widget-box'>
          <div class='widget-title'> <span class='icon'> <i class='icon-th'></i> </span>
            <h5>Member's Membership table</h5>
  ...
  $result=mysqli_query($conn,$qry);
    ...
    echo"<table class='table table-bordered data-table table-hover'>
      ...
      <tbody> 
          ...
          <td><div class='text-center'><a href='user-payment.php?id=<?php echo $row['user_id']?>'><button class='btn btn-success btn'><i class='icon icon-money'></i> Renew </button></a></div></td>
