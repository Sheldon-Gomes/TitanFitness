...
<!--Header-part-->
<div id="header">
  <h1><a href="dashboard.php">Titan Fitness</a></h1>
</div>
<!--close-Header-part--> 
                                            ...
                                            <tr>
                                                <td class="content-block">
                                                    <table class="invoice">
                                                        <tbody>
                                                        <tr>
                                                            <td><div style="float:left">Invoice #GMS_<?php echo(rand(100000,10000000));?><br> Mumbai, <br>India </div><div style="float:right"> Last Payment: <?php echo $paid_date?></div></td>
                                                        </tr>
